...
schtasks /create /tn "FLEET\WAKE-LSN"       /tr "wscript.exe //B //Nologo C:\ProjectOS-AI\scripts\run-hidden.vbs powershell -NoProfile -ExecutionPolicy Bypass -File C:\Push-to-Prod-2026\learning-start-nexus\scripts\wake.ps1 -RepoRoot C:\Push-to-Prod-2026\learning-start-nexus -Seat LSN" /sc daily /st 09:10 /ri 20 /du 10:00 /f
